...
public class ModuleBandofAuraUnit implements ICustomModule<ModuleBandofAuraUnit> {

    @Override
    public void tickServer(IModule<ModuleBandofAuraUnit> module, EntityPlayer player) {
