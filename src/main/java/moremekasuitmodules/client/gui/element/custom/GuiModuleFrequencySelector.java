package moremekasuitmodules.client.gui.element.custom;
...
import moremekasuitmodules.common.network.to_server.PacketModuleGuiSetFrequency.FrequencyUpdate;
...
public class GuiModuleFrequencySelector<FREQ extends Frequency> extends GuiElement {
    ...
    public<SELECTOR extends IGuiWrapper&IGuiFrequencySelector<FREQ>> GuiModuleFrequencySelector(SELECTOR frequencySelector, int yStart) {
    ...
    public interface IItemGuiFrequencySelector<FREQ extends Frequency, CONTAINER extends FrequencyItemContainer<FREQ>> extends IGuiFrequencySelector<FREQ> {
        ...
        default void sendSetFrequency(FrequencyIdentity identity) {
            MoreMekaSuitModules.packetHandler().sendToServer(PacketModuleGuiSetFrequency.create(FrequencyUpdate.SET_ITEM, getFrequencyType(), identity));
        }

        @Override
        default void sendRemoveFrequency(FrequencyIdentity identity) {
            MoreMekaSuitModules.packetHandler().sendToServer(PacketModuleGuiSetFrequency.create(FrequencyUpdate.REMOVE_ITEM, getFrequencyType(), identity));
        }
